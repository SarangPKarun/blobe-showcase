...
function initScene({ geo }) {
  ...
  function animate() {
    ...
    // Moves the astronaut up/down and forward/backward with scroll
    // const targetY = -0.5 + scrollPosY * 3.0; // move up 3 units max
    // const targetZ = 0 - scrollPosY * 2.0;    // move slightly closer
    // mesh.position.y -= (mesh.position.y - targetY) * rate;
    // mesh.position.z -= (mesh.position.z - targetZ) * rate;
